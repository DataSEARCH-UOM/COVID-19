...
<div class="wrapper">
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white no-left-margin">
        <div class="container">
    ...
    <div class="content-wrapper no-left-margin" style="min-height: 917px;">
        <!-- Main content -->
...
<script src="{{asset('plugins/jquery-mapael/maps/sri_lanka.min.js')}}"></script>
<!-- ChartJS -->
